...
var txt2 = {
  "new_dir":"新しいアカウントディレクトリを作成する場合、アカウント名を入力して、ボタンを押してください。\nデスクトップにBUYMAディレクトリが作成され、その中のaccountディレクトリ内に新しく作成されます。",
  "choice_dir":"出品するアカウントのディレクトリを選択します。\n事前にdataディレクトリからcsvと画像データを移動しておいてください。",
  "reset":"開いたディレクトリや表示したCSVをリセットできます。",
  "days":"過去の出品との重複を検知します。\n指定した日付以降に出品されていた場合スキップされます。",
  "memo":"BUYMAの出品時に買い付け先メモを記入するかどうか選択できます。「on」か「off」かで記入してください。",
  "duplicate":"BUYMAの出品時に重複チェックをするかどうか選択できます。「on」か「off」かで記入してください。",
  "access_code":"Chromeから取得したアクセスコードを入力してください。\n詳しい取得方法は動画を参照してください。"
}
// ヘルプボタン
